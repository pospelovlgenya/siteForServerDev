"""
Django settings for siteForServerDev project.
...
JWT_TOKEN_LIFETIME = timedelta(minutes=10)
JWT_UPDATED_AUTODELETE_IN_MINS = 20
...
ROOT_URLCONF = 'siteForServerDev.urls'
...
WSGI_APPLICATION = 'siteForServerDev.wsgi.application'
